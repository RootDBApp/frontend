...
export const UPDATE_REPORT_DATAVIEW_RUNTIME_CONFIGURATION = 'UPDATE_REPORT_DATAVIEW_RUNTIME_CONFIGURATION';
export type TUpdateReportDataViewRunTimeConfiguration = typeof UPDATE_REPORT_DATAVIEW_RUNTIME_CONFIGURATION;
