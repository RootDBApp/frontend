...
export const REPORT_DATAVIEW_SET_CHARTJS_CONFIGURATOR_OBJECT = "REPORT_DATAVIEW_SET_CHARTJS_CONFIGURATOR_OBJECT";
export type TReportDataViewSetChartJsConfiguratorObject = typeof REPORT_DATAVIEW_SET_CHARTJS_CONFIGURATOR_OBJECT;

export const REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_DATA_SET = "REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_DATA_SET";
export type TReportDataViewUpdateChartJsConfiguratorDataSet = typeof REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_DATA_SET;

export const REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_DATA_SET_FROM_RESULTS = "REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_DATA_SET_FROM_RESULTS";
export type TReportDataViewUpdateChartJsConfiguratorDataSetsFromResults = typeof REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_DATA_SET_FROM_RESULTS;

export const REPORT_DATAVIEW_SET_CHARTJS_CONFIGURATOR_INITIAL_SETUP_DONE = "REPORT_DATAVIEW_SET_CHARTJS_CONFIGURATOR_INITIAL_SETUP_DONE";
export type TReportDataViewSetChartJsConfiguratorInitialSetupDone = typeof REPORT_DATAVIEW_SET_CHARTJS_CONFIGURATOR_INITIAL_SETUP_DONE;

export const REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_OPTIONS = "REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_OPTIONS";
export type TReportDataViewUpdateChartJsConfiguratorOptions = typeof REPORT_DATAVIEW_UPDATE_CHARTJS_CONFIGURATOR_OPTIONS;
