...
export const REPORT_DATAVIEW_SET_CHARTJS_OBJECT = "REPORT_DATAVIEW_SET_CHARTJS_OBJECT";
export type TReportDataViewSetChartJsObject = typeof REPORT_DATAVIEW_SET_CHARTJS_OBJECT;

export const REPORT_DATAVIEW_UPDATE_CHARTJS_DATA_SET = "REPORT_DATAVIEW_UPDATE_CHARTJS_DATA_SET";
export type TReportDataViewUpdateChartJsDataSet = typeof REPORT_DATAVIEW_UPDATE_CHARTJS_DATA_SET;
