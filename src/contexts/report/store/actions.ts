...
export interface IReportDataViewUpdateChartJsConfiguratorDataSetsFromResults {
    ...
    payload: { labels: Array<string>, datasets: Array<ChartDataset>, reportId: number, dataViewId: number },
}
...
export const reportDataViewUpdateChartJsConfiguratorDataSetsFromResults = (payload: { labels: Array<string>, datasets: Array<ChartDataset>, reportId: number, dataViewId: number }): IReportDataViewUpdateChartJsConfiguratorDataSetsFromResults => ({
